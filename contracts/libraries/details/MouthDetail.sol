...
library MouthDetail {
    ...
    function item_11() public pure returns (string memory) {
        return
            base(
                '<path display="inline" fill-rule="evenodd" clip-rule="evenodd" d="M227.4,254h-46.7c-0.5,0-0.9-0.4-0.9-0.9v-2c0-0.5,0.4-0.9,0.9-0.9h46.7c0.5,0,0.9,0.4,0.9,0.9v2C228.2,253.7,228,254,227.4,254z"  /><path display="inline" fill-rule="evenodd" clip-rule="evenodd" stroke="#000000" stroke-linecap="round" stroke-miterlimit="10" d="M180.4,251.1c-0.9,9.5-0.5,18.8,0.5,29.7"  /><path display="inline" fill-rule="evenodd" clip-rule="evenodd" stroke="#000000" stroke-linecap="round" stroke-miterlimit="10" d="M227.7,251c0.5,10.5,0.1,22.5-0.7,35.3"  />'
            );
    }
    ...
    function item_17() public pure returns (string memory) {
        return
            base(
                '<g display="inline" ><polyline fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" points="222.4,251.9 225.5,260.1 230,251.7 " /><path d="M222.4,251.9c0.6,1.4,1.1,2.6,1.8,4c0.5,1.4,1,2.7,1.6,4h-0.4c0.3-0.7,0.7-1.4,1.1-2.1l1.1-2.1c0.8-1.4,1.6-2.7,2.4-4.1c-0.6,1.5-1.4,2.9-2.1,4.3l-1,2.1c-0.4,0.7-0.7,1.5-1.1,2.1l-0.3,0.5l-0.2-0.5c-0.5-1.4-1-2.7-1.5-4.1C223.3,254.7,222.8,253.3,222.4,251.9z" /></g><g display="inline" ><polyline fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" points="187.3,252 184,259.7 180,251.5 " /><path d="M187.3,252c-0.4,1.4-0.9,2.7-1.5,4c-0.5,1.4-1,2.6-1.6,4l-0.2,0.5l-0.3-0.5c-0.3-0.6-0.6-1.4-1-2.1l-1-2.1c-0.6-1.4-1.3-2.7-1.9-4.2c0.8,1.4,1.5,2.6,2.2,4l1,2c0.3,0.7,0.7,1.4,1,2.1h-0.4c0.5-1.3,1-2.6,1.7-3.9C186.2,254.5,186.7,253.2,187.3,252z" /></g><path display="inline" fill-rule="evenodd" clip-rule="evenodd" d="M174.6,251c0,0,24.6,3.4,60.2,0.5"  /><g display="inline" ><path d="M195.8,256.6c1.1,0.3,2.4,0.5,3.5,0.6c1.3,0.1,2.4,0.2,3.6,0.2s2.4-0.1,3.6-0.2s2.4-0.2,3.6-0.4c-0.6,0.2-1.1,0.4-1.8,0.6c-0.6,0.1-1.3,0.3-1.8,0.4c-1.3,0.2-2.5,0.3-3.8,0.3s-2.5-0.1-3.8-0.3C197.9,257.6,196.8,257.2,195.8,256.6z" /></g>'
            );
    }
