        ...
        return
            string(
                abi.encodePacked(
                    ...
                    abi.encodePacked(
                        '<g> <path fill-rule="evenodd" clip-rule="evenodd" fill="#',
                        colorTomoe,
                        '" d="M205.4,183.2c0,0,4.8-1.9,11,3.2c0,0-3.2-1.1-5.9-0.1"/> <path fill-rule="evenodd" clip-rule="evenodd" fill="#',
                        colorTomoe,
                        '" d="M205.5,183.1c-2.4,0.4-4,2.7-3.4,5c0.4,2.4,2.7,4,5,3.4 c2.4-0.4,4-2.7,3.4-5C210.2,184.2,207.9,182.7,205.5,183.1z M206.6,188.8c-0.8,0.1-1.5-0.4-1.7-1.1c-0.1-0.8,0.4-1.5,1.1-1.7 c0.8-0.1,1.5,0.4,1.7,1.1S207.3,188.6,206.6,188.8z"/> </g> <g> <path fill-rule="evenodd" clip-rule="evenodd" fill="#',
                        colorTomoe,
                        '" d="M187.5,190.7c0,0-4.4-2.6-4.3-10.7c0,0,1,3.2,3.5,4.7"/> <path fill-rule="evenodd" clip-rule="evenodd" fill="#',
                        colorTomoe,
