...
library AccessoryDetail {
    /// @dev Accessory N°1 => Bloody Horn
    function item_1() public pure returns (string memory) {
        return base(horn("E31466"));
    }

    /// @dev Accessory N°2 => Bloody Small Horn
    function item_2() public pure returns (string memory) {
        return base(small_horn("E31466"));
    }

    /// @dev Accessory N°3 => Bloody Monk
    function item_3() public pure returns (string memory) {
        return base(monk("B50D5E"));
    }

    /// @dev Accessory N°4 => Moon Horn
    function item_4() public pure returns (string memory) {
        return base(horn("2A2C38"));
    }

    /// @dev Accessory N°5 => Lunar Small Horn
    function item_5() public pure returns (string memory) {
        return base(small_horn("2A2C38"));
    }

    /// @dev Accessory N°6 => Lunar Monk
    function item_6() public pure returns (string memory) {
        return base(monk("242630"));
    }

    /// @dev Accessory N°7 => Power Stick
