...
library AccessoryDetail {
    ...
    /// @dev Accessory N°4 => Monk White
    function item_4() public pure returns (string memory) {
        return base(monk("FFEDED"));
    }

    /// @dev Accessory N°5 => Eye
    function item_5() public pure returns (string memory) {
        return
            base(
                '<path display="inline" fill-rule="evenodd" clip-rule="evenodd" d="M197.9,132.9c0,0-15.2,17-0.1,39.9C197.9,172.7,212.8,154.7,197.9,132.9z"  /><g display="inline" ><path d="M205,139.4c0.9,2.2,1.6,4.5,2,6.8s0.6,4.7,0.6,7.1s-0.3,4.8-0.9,7.1c-0.5,2.3-1.6,4.5-2.7,6.6c0.2-0.5,0.4-1.1,0.6-1.7l0.3-0.8l0.2-0.8l0.5-1.7l0.4-1.7c0.4-2.3,0.7-4.6,0.7-7c0.1-2.3-0.1-4.7-0.4-7c-0.1-1.1-0.3-2.3-0.6-3.4C205.5,141.7,205.2,140.6,205,139.4z" /></g><g display="inline" ><path d="M188.9,155.2c0.2,1.4,0.4,2.8,0.7,4.2s0.5,2.7,0.9,4.1c0.3,1.4,0.8,2.7,1.4,4c0.5,1.3,1.1,2.5,1.9,3.8c-0.9-1-1.7-2.3-2.3-3.5c-0.6-1.3-1-2.6-1.5-4c-0.3-1.4-0.6-2.7-0.8-4.2C189,158,188.9,156.6,188.9,155.2z" /></g><ellipse transform="matrix(0.986 -0.1668 0.1668 0.986 -21.4564 35.5318)" display="inline" fill-rule="evenodd" clip-rule="evenodd" fill="#FFFFFF" cx="200.8" cy="145.5" rx="0.8" ry="3.2"  />'
            );
    }

    /// @dev Accessory N°6 => Small Horn White
    function item_6() public pure returns (string memory) {
        return base(small_horn("FFDAEA"));
    }

    /// @dev Accessory N°7 => Horn White
    function item_7() public pure returns (string memory) {
        return base(horn("FFDAEA"));
    }

    /// @dev Accessory N°8 => Kitsune
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    color,
                    '" stroke="#2A2C38" stroke-miterlimit="10" d="M258.2,101.1c0,0.1,1,9.2,10.6,11.4" /></g><g display="inline" ><path fill-rule="evenodd" clip-rule="evenodd" fill="#',
                    color,
                    ...
                    color,
                    '" stroke="#2A2C38" stroke-miterlimit="10" d="M158.9,102c0,0.1-1.5,9.4-10.7,11.3" /></g>'
                )
            );
    }
