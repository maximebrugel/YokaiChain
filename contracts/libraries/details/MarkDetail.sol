...
library MarkDetail {
    ...
    function item_1() public pure returns (string memory) {
        return
            base(
                '<stop offset="0" style="stop-color:#FFB451"  /><stop offset="0.5259" style="stop-color:#F7EC94"  /><stop offset="1" style="stop-color:#FF9121"  />'
            );
    }
    ...
    function item_6() public pure returns (string memory) {
        return
            base(
                '<g id="Eye_Mark_00000034091419957960051340000007650225927121068221_" display="inline" ><g><path fill="#FFEDED" d="M238.6,224c0-3.6,2.6-85.2,2.8-88.9c0.1-3.6-1.8-24.7-1.6-28.3c5.6-6.5,15.5-32.8,20.1-32.6c-4.6,2.3-12.5,28.8-15.7,32.6l-0.2,31.1c0.1,3.6-2.4,82.5-2.2,86.2c-0.4,0.4-1.3,1.7-1.6,2.2C239.7,225.4,238.6,224,238.6,224z" /></g></g><g id="Eye_Mark_00000161610524051233701840000007265649441665785232_" display="inline" ><g><path fill="#FFEDED" d="M160.2,222.8c-0.1-3.6,0.1-88.4,0.2-92c0-3.6,1.8-21.8,2-25.4c5.5-6.6,13.7-35,18.2-34.9c-5.3,2-11.6,33.3-14.7,37.3l-2.8,25.6c0.2,3.6,0,85.7,0.3,89.3l-1.7,3.1L160.2,222.8z" /></g></g>'
            );
    }
    ...
    function item_8() public pure returns (string memory) {
        return
            base(
                '<path id="Scar" display="inline" fill="#FF7478" d="M239.9,133.5c0,0-7.5,51,0.2,101.2C240.1,234.7,248.8,188.3,239.9,133.5z"  /><path id="Scar_00000004533207604881262600000012666582110178774184_" display="inline" fill="#FF7478" d="M163.7,135.1c0,0-6.9,51.1,1.6,101.2C165.2,236.2,173.1,189.8,163.7,135.1z"  />'
            );
    }
    ...
    function item_18() public pure returns (string memory) {
        return
            base(
                '<g id="Eye_Mark_00000175285842010430468260000007389249013439804862_" display="inline" ><g><path d="M238.6,224c0-3.6,2.6-85.2,2.8-88.9c0.1-3.6-1.8-24.7-1.6-28.3c5.6-6.5,15.5-32.8,20.1-32.6c-4.6,2.3-12.5,28.8-15.7,32.6l-0.2,31.1c0.1,3.6-2.4,82.5-2.2,86.2c-0.4,0.4-1.3,1.7-1.6,2.2C239.7,225.4,238.6,224,238.6,224z" /></g></g><g id="Eye_Mark_00000155833185527664036580000015871969909210297514_" display="inline" ><g><path d="M160.6,222.7c-0.1-3.6-0.3-88.3-0.2-91.9c0-3.6,1.8-21.8,2-25.4c5.5-6.6,13.7-35,18.2-34.9c-5.3,2-11.6,33.3-14.7,37.3l-2.8,25.6c0.2,3.6,0.4,85.6,0.7,89.2l-1.7,3.1L160.6,222.7z" /></g></g>'
            );
    }
